package Reading;
	...
	public class CopyContentOneWorkbookToOthertesting {

		public static void main(String[] args) throws IOException 
		{
			// Step #1 : Locate path and file of input excel.
			File inputFile=new File("C:\\Users\\vinod\\Desktop\\testing.xlsx");
			...
			File outputFile=new File("C:\\Users\\vinod\\Desktop\\writefile.xlsx");
